...
# IMPORTANT: Register document generation router BEFORE documents router to avoid route conflicts
# This ensures /documents/generate routes are matched before /documents routes
