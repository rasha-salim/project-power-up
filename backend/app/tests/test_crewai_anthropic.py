...
def test_anthropic_integration():
    """
    Test the integration between CrewAI and Anthropic
    """
    print("\n===== STARTING ANTHROPIC INTEGRATION TEST =====\n")
    ...
    try:
        # Create a simple agent with Anthropic LLM
        print("\n📋 Step 1: Creating agent with Anthropic LLM...")
        logger.info("Creating agent with Anthropic LLM...")
        
        # Initialize ChatAnthropic
        print(f"   - Initializing Anthropic LLM with model: claude-3-haiku-20240307")
        llm = ChatAnthropic(
...
def run_test():
    """Run the test and catch any exceptions at the top level"""
    try:
        print("\n===== RUNNING ANTHROPIC INTEGRATION TEST =====\n")
        ...
        print("\n===== ANTHROPIC INTEGRATION TEST FAILED WITH CRITICAL ERROR =====\n")
        return False
